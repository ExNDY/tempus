...
class StreamingCacheDataSource private constructor(
    ...
    class Factory(private val cacheDatasourceFactory: CacheDataSource.Factory) :
        DataSource.Factory {
    ...
    override fun close() {
        ...
        if (dataSpec != null) {
            ...
            val contentLength =
                ContentMetadata.getContentLength(cacheDataSource.cache.getContentMetadata(cacheKey));
